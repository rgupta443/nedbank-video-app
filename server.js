// Its a server-side implemetation of the chat system, including user ID management,
// sending JSON objects, and signaling for WebRTC.
...
const keyFilePath = "assets/cert/key.pem";
const certFilePath = "assets/cert/cer.pem";

// Used for managing the text chat user list.

var connectionArray = [];
var nextID = Date.now();  // returns the number of milliseconds
...
function sendCallerCallee(details) {
...
try {
   httpsOptions.key = fs.readFileSync(keyFilePath, 'utf');
   try {
      httpsOptions.cert = fs.readFileSync(certFilePath, 'utf');
   } catch (err) {
...
webServer.listen(process.env.PORT || 6503, function () {
